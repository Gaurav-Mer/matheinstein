...
export default function Class2Curriculum() {
    return (
        <motion.div
            ...
            className=" bg-card border-2 border-blue-500  -rotate-1  rounded-2xl p-8  max-w-full mx-"
        >
            <div className="flex items-center gap-2 mb-6">
                <div className="w-14 h-14 rounded-xl bg-card flex items-center justify-center border border-blue-300">
