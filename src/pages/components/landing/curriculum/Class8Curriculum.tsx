...
export default function Class8Curriculum() {
    return (
        <motion.div
            ...
            className=" bg-card border-2 border-sky-500  -rotate-1  rounded-2xl p-8  max-w-full mx-auto"
        >
            <div className="flex items-center gap-2 mb-6">
                <div className="w-14 h-14 rounded-xl bg-card flex items-center justify-center border border-sky-300">
