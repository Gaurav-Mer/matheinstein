...
export default function Class5Curriculum() {
    return (
        <motion.div
            ...
            className=" bg-card border-2 border-orange-500 -rotate-1  rounded-2xl p-8  max-w-full mx-auto"
        >
            <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 rounded-xl bg-card flex items-center justify-center border border-orange-300">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-muted-foreground text-sm">
                {[
                    ...
                    <li key={i} className="flex items-center gap-2 bg-card px-3 p-12 rounded-lg text-3xl justify-center">
